...
namespace iRan.BLL
{
	...
	{
		private readonly iRan.DAL.AdminsDAL dal=new iRan.DAL.AdminsDAL();
		public AdminsBLL()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public iRan.Model.Admins GetModelByCache(int AdminID)
		{
			
			string CacheKey = "AdminsModel-" + AdminID;
			...
			return (iRan.Model.Admins)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<iRan.Model.Admins> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<iRan.Model.Admins> DataTableToList(DataTable dt)
		{
			List<iRan.Model.Admins> modelList = new List<iRan.Model.Admins>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				iRan.Model.Admins model;
